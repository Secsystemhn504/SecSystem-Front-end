...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->slot('description'); ?> 
        <?php echo e(__('Agregue seguridad adicional a su cuenta mediante la autenticación de dos pasos.')); ?>
     ...
     <?php $__env->slot('content'); ?> 
        ...
        <div class="mt-3 max-w-xl text-sm text-gray-600">
            <p>
                <?php echo e(__('Cuando la autenticación de dos factores está habilitada, se le solicitará un token aleatorio seguro durante la autenticación. Puede recuperar este token de la aplicación Autenticador de Google de su teléfono.')); ?>
        ...
        <?php if($this->enabled): ?>
            ...
            <?php if($showingRecoveryCodes): ?>
                <div class="mt-4 max-w-xl text-sm text-gray-600">
                    <p class="font-semibold">
                        <?php echo e(__('Guarde estos códigos de recuperación en un administrador de contraseñas seguro. Se pueden usar para recuperar el acceso a su cuenta si pierde su dispositivo de autenticación de dos factores.')); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\proyecto\resources\views/profile/two-factor-authentication-form.blade.php ENDPATH**/ ?>