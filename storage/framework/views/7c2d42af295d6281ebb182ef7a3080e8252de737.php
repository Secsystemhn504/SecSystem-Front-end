                    ...
                    <div class="card card-warning">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.clientes.create')): ?>
                                    <div class="col-sm-12">
                                        <a type="button" class="btn btn-warning" href="<?php echo e(route('admin.clientes.create')); ?>"><i class="fa fa-pen"></i> Agregar</a>
                                    </div>
                                <?php endif; ?>
                            </div>
                            <table id="example1" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th scope="col" width="10px">Cod Cliente</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th><?php echo e($cliente->cod_cliente); ?></th>
                                        <td><?php echo e($cliente->cod_persona); ?></td>
                                        <td><?php echo e($cliente->nom_empresa); ?></td>
                                        <td><?php echo e($cliente->correo_electronico); ?></td>
                                        <td><?php echo e($cliente->cod_contratos); ?></td>
                                        <td><?php echo e($cliente->des_contrato); ?></td>
                                        <td><?php echo e(\Carbon\Carbon::parse($cliente->fec_ini_contrato)->formatLocalized('%d de %B del %Y')); ?></td>
                                        <td><?php echo e(\Carbon\Carbon::parse($cliente->fec_fin_contrato)->formatLocalized('%d de %B del %Y')); ?></td>
                                        <td><?php echo e($cliente->tipo_contrato); ?></td>
                                        <td><?php echo e($cliente->usr_registro); ?></td>
                                        <td><?php echo e($cliente->fec_registro); ?></td>
                                        <td>
                                            <div class="btn-group">
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.clientes.edit')): ?>
                                                    <a href="<?php echo e(route('admin.clientes.edit', $cliente->cod_cliente)); ?>" class="btn btn-warning btnEditarCliente"><i class="fas fa-pencil-alt"></i></a>
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.clientes.show')): ?>
                                                    <a href="<?php echo e(route('admin.clientes.show', $cliente->cod_cliente)); ?>" class="btn btn-primary btnVerCliente"><i class="fas fa-eye"></i></a>
                                                <?php endif; ?>
                                            </div>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\proyecto\resources\views/admin/cliente/index.blade.php ENDPATH**/ ?>